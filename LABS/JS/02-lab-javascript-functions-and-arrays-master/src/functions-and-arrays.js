...
// Iteration #3.1 Bonus: ----------------------------------------------ERROR NOT WORKING
...
function averageWordLength(wordsArr) {
  ...
  wordsArr.forEach((element) => {
    sum4 += element.length;
    avg4 = sum4 / wordsArr.length;
  });
  if (wordsArr.length === 0) avg4 = null;
  return avg4;
}
...
function avg(mixedArr) {
  ...
  result = mixedSum / mixedArr.length;
  if (mixedArr.length === 0) result = null;
  return result;

  // let result = sum(mixedArr) / mixedArr.length;
  // if (mixedArr.length === 0) result = null;
  // return result;
}

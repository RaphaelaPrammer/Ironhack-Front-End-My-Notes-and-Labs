...
<script setup>
import { ref } from "vue";
import CustomEventsEmits from "./11-1-EventsChild.vue";
...
// // Ej. 2: Creamos tres componentes: General.vue, Input.vue y Submit.vue.
//General debe enseñar en un < h1 > una variable reactiva con vuestro nombre.Input debe contener un input type text y Submit.vue debe ser un botón.
//En el script de General vamos a crear la función changeName(), la cual va a aceptar un argumento y cambiará el valor de la variable reactiva por el de dicho argumento.

...
createDiv1.setAttribute("id", "insert-p");

const createP = document.createElement("p");
createP.innerText = "HHHelloO";

document.querySelector("body").appendChild(createDiv1);

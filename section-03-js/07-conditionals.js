...
//< 15 - 20%
//< 5 - gratis
// >= 15 y <=60 pagar normal
// >60 40%

// const customerAge = parseInt(prompt("How old are you?"));
// if (customerAge <= 5) {
//   console.log("You can enjooy the movie for free.Lucky you ");
// } else if (customerAge < 15) {
//   console.log("You get a 20% discount");
// } else if (customerAge >= 15 && customerAge <= 60) {
//   console.log("Sorry, no discount. You have to pay the regular price");
// } else {
...
// Switch Example complex - Calculator:
let result;
const operator = prompt("Enter operator");
const calcNum1 = parseFloat(prompt("Enter first number"));
const calcNum2 = parseFloat(prompt("Enter second number"));
...
switch (operator) {
  ...
  case "/":
    ...
    break;
  default:
    console.log("This is not a operator");
    break;
}
console.log("-----------------------");
//-----------------------
// Switch Example complex - Country continent finder - multiple cases:
const countryOfOrigen = prompt("What country were you born");
switch (countryOfOrigen.toLowerCase()) {
  case "venezuela":
  case "colombia":
  case "ecuador":
  case "argentina":
    alert(`cool ${countryOfOrigen} is located in SouthAmerica`);
    console.log(`cool ${countryOfOrigen} is located in SouthAmerica`);
    break;
  case "germany":
  case "spain":
  case "france":
  case "portugal":
  case "italy":
    alert(`cool ${countryOfOrigen} is located in Europe`);
    console.log(`cool ${countryOfOrigen} is located in Europe`);
    break;
  default:
    alert("you are not from this planet");
    console.log("you are not from this planet");
    break;
}

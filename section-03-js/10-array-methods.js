...
let firstArray = ["london", "helsinki", "barcelona", "vienna"];
let secondArray = ["Istanbul", "Berlin"];
console.log(firstArray);
console.log(secondArray);

let newArray = firstArray.unshift(secondArray[0]);
newArray = firstArray.push(secondArray[1]);
console.log(firstArray);
